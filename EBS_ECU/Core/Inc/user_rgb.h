...
#ifndef INC_USER_RGB_H_
#define INC_USER_RGB_H_
...
void ASSI_OFF(void);
void ASSI_Blue_Stable(void);
void ASSI_Blue_Blink(void);
void ASSI_Yellow_Stable(void);
void ASSI_Yellow_Blink(void);
void WS2812_Update();
#endif /* INC_USER_RGB_H_ */
